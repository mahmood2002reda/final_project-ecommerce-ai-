...
<body>
        ...
        <thead>
            <tr>
                <th width="50%" colspan="2">
                    <h2 class="text-start">UReflect Ecommerce</h2>
                </th>
                <th width="50%" colspan="2" class="text-end company-data">
                    <span>Invoice Id: #{{$order->id}}</span> <br>
                    <span>Date: {{date('d/m/Y')}}</span> <br>
                    <span>Zip code :  54790</span> <br>
                    <span>Address: #555, Main st,</span> <br>
                </th>
            </tr>
            <tr class="bg-blue">
    ...
    <table>
        ...
        <tbody>
           ...
           <td width="15%" class="fw-bold">{{$orderItem->quantity * $orderItem->price ?? ''}}L.E</td>
           @php
           ...
           <tr>
            ...
            <td colspan="1" class="total-heading">{{$totalPrice}}L.E</td>
           </tr>
        </tbody>
    </table>
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with UReflect
    </p>
