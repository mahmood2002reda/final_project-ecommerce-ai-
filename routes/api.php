...
Route::post('read-temp-file', [AiModelController::class, 'readFile']);

Route::post('processDc', [AiModelController::class, 'processDc']);

Route::post('processHD/{id}', [AiModelController::class, 'index']);
...
Route::prefix('products')->group(function(){
    ...
    Route::get('mostView',[ProductController::class, 'mostView']);
...
Route::prefix('Wishlist')->middleware('auth:sanctum')->group(function(){
    ...
    Route::post('delete/{prodctId}',[ProductController::class, 'deleteWishlist']);
    Route::get('mywishlist',[ProductController::class, 'myWishlist']);
    Route::delete('{reviewId}/delete/{prodctId}', [ReviewController::class, 'destroy']);
   });
});
